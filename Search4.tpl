...
<div id="container">
      ...
      % for vid in content['videos']:
        <div id="inner" style="overflow:hidden;width: 2000px">
          <section class="pod">
            <form action = "/vote/{{content['session']}}/add" method="post">
              <figure class="podContent"><img src="{{vid["thumbnail_url"]}}" width="120" height="90" alt="specials"></figure>
              <div class="podContent" id="info" style="width: 280px; margin-left:10px">
                  <p>{{vid["title"]}}</p>
                  <p>{{vid["vid_time"]}}</p>
              </div>
              <div class="podContent" id="hide" style="width: 1px">
                  <input type="hidden" name="vid_url" value="{{vid["vid_url"]}}">
                  <input type="hidden" name="thumbnail_url" value="{{vid["thumbnail_url"]}}">
                  <input type="hidden" name="title" value="{{vid["title"]}}">
                  <input type="hidden" name="vid_time" value="{{vid["vid_time"]}}">
              </div>
              <figure class="podContent" style="width: 80px"><input type = "image" img src="http://i.imgur.com/Q4AaL.png" width="80" height="80"/></figure>
              </form>&nbsp;
            </section>
        </div>
	%end 
